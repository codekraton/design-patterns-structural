package com.codekraton.designpatterns.structural.adapters;
...
public class EmployeeClient {
	...
	public List<Employee> getEmployeeList() {
		...
		/*
			TODO: Excercise one
			Create adapters so that we can add the three types of legacy com.codekraton.designpatterns.structural.adapters.Employee objects to the list of Employees.
